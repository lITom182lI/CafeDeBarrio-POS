...
namespace CafeBarrio.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260613021158_AUD04_UniqueActiveConfigPerSede")]
    partial class AUD04_UniqueActiveConfigPerSede
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CafeBarrio.Domain.Entities.Cliente", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasDatabaseName("UX_Cliente_Email");
